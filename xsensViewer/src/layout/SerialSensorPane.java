...
//		firmwareLabel.setTooltip(new Tooltip("The current firmware version"));
	...
	public void setDataLabelData(SensorData sensormessage){
		...
		if (sensormessage.batteryLevel!=null) {
			...
			System.out.println("Battery level: " + sensormessage.batteryLevel + "  " + sensormessage.batteryLevelV);
			
			if (batteryLevel>1) {
				batteryLevel = batteryLevel/100.;
			}
						
			if (batteryLevel>0.98) {
				batteryLevel=1.; 
			}
			batLabel.setText(String.format("%.0f ", batteryLevel*100.) + "%: " + String.format("%.2fV", sensormessage.batteryLevelV.get()));
		}
